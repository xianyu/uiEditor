...
#include "../uiEditor/analysis/analysis.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_analysis_t, stringdata) + ofs \
...
const QMetaObject analysis::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_analysis.data,
      qt_meta_data_analysis,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_analysis.stringdata))
