...
#include "../uiEditor/attribute/attribute.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_attribute_t, stringdata) + ofs \
...
const QMetaObject attribute::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_attribute.data,
      qt_meta_data_attribute,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_attribute.stringdata))
